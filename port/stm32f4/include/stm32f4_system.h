 ...
 */
 ...
 /**
  * @brief Function that will be called when we want to read the digital value of a pin. We will read a 1 or a 0 logical, therefore, the function returns bool
  *
  * @param p_port Port of the GPIO (CMSIS struct like)
  * @param pin Pin/line of the GPIO (index from 0 to 15)
  *
  * @retval Value of the GPIO (true if high, false if low)
  */
 bool stm32f4_system_gpio_read(GPIO_TypeDef * p_port, uint8_t pin);
 
 /**
  * @brief This function is very convenient when we want to invert the value of a pin. If it was high ( 1 logical), which goes to low (logical 0), and vice versa. This function uses the previous two; read the value of pin and write the opposite.
  * 
  * @param p_port Port of the GPIO (CMSIS struct like)
  * @param pin 	Pin/line of the GPIO (index from 0 to 15)
  */
 ...
 /**
  * @brief Function that will be called when we want to write a digital value to a pin. We will write 1 or 0 logical
  * 
  * @param p_port Port of the GPIO (CMSIS struct like)
  * @param pin 	Pin/line of the GPIO (index from 0 to 15)
